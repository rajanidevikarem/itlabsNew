...
{/* <button className= 'text-center text-black px-6 py-3 rounded-lg my-5 bg-lime-500 font-medium'>Explore Our Services</button> */}
       ...
       <h1 className='font-medium my-5 mx-auto text-white text-2xl lg:text-5xl pt-2 text-center lg:leading-normal'>Mission</h1>
      <p className='text-center text-white lg:p-4 p-6'> ITLabs is dedicated to creating a thriving ecosystem where clients, employees, and stakeholders achieve their full potential. <br/>We achieve this by: </p>
...
<path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" />
  ...
  <div className='grid grid-cols grid-rows-6 ' data-aos="fade-right">
       ...
       <section className='lg:py-16 py-8'>
       <h1 className='font-medium lg:my-5 my-2 mx-auto text-white text-2xl lg:text-5xl pt-2 text-center lg:leading-normal'> What We Do</h1>
      <p className='text-white text-center lg:p-4 p-2'> At ITLABs we provide a comprehensive suite of IT staffing and consulting services <br/>to help businesses achieve their goals. </p>
      ...
      <div className='px-10 lg:px-28 leading-relaxed' data-aos='fade-right'>
        <div className='w-full grid m-auto lg:grid-cols-3 gap-4 py-8  text-white'>
         <div className='flex flex-col h-full justify-center border rounded-2xl list-icons shadow-md'>
      ...
      <p className='text-center text-white lg:p-4 p-8'> Our expert consultants and staff deliver customized solutions that prioritize your success. </p>
  ...
  <div className='grid grid-cols grid-rows-6' data-aos="fade-left">
        ...
        <div className='lg:mx-8 mx-2'>
          <ul>
            <li className='flex items-start lg:my-6 my-2'>
            <div className='py-4 px-4 items-center my-4 list-icons rounded-lg'>
             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
  <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" />
</svg>
