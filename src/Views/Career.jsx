...
<div className=' max-w-[1140px] mx-auto p-4'>
 ...
 <Link to="/Currentopening " className='text-white px-4'><button className= 'text-center text-black px-6 py-3 rounded-lg my-5 bg-lime-500 font-medium'>Explore Jobs</button></Link>
  ...
  <section className='py-16 bg-gradient-to-r from-[#1D1422] to-[#2E233B]'>
   ...
   At ITLABS, you'll do more than just work. You'll be a visionary.  We innovate, we collaborate, and we empower our clients to achieve their tomorrow.
We believe our greatest asset is our team – talented individuals with a passion for technology and a drive to make a difference.
  ...
  <h1 className='font-medium my-5 mx-auto text-white text-2xl lg:text-5xl pt-2 text-center lg:leading-normal'>Life at ITlabs</h1>
...
<path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" />
 ...
 <div className='grid grid-cols grid-rows-6' data-aos="fade-right">
  ...
  <section className='lg:py-16 py-8'>
  <h1 className='font-medium my-5 mx-auto text-white text-2xl lg:text-5xl pt-2 text-center lg:leading-normal'>What We Look For</h1>
  <div className='w-full m-auto px-4 lg:px-28 py-16 grid lg:grid-cols-2 gap-4'>
     {/* right Side */}
